...
public class MensagemErro {
	...
	public static final String EMAIL_NAO_INFORMADO = "Email não infomado";
	public static final String CONFIRMACAO_DE_EMAIL_INVALIDA = "Emails informado não conferem";
	public static final String CONFIRMACAO_DE_EMAIL_NAO_INFORMADA = "Confirmação de email não informada";
	public static final String TAMANHO_DE_SENHA_INVALIDO = "Tamanho de senha foge aos padrões do ControleF";
	public static final String SENHA_NAO_INFORMADA = "Senha não infomado";
	public static final String ERRO_CONFIRMA_SENHA = "Erro ao confirmar senha";
	public static final String TIPO_DOCUMENTO_INVALIDO = "Tipo de documento inválido";
	public static final String CPF_INVALIDO = "Cpf inválido";
	public static final String CNPJ_INVALIDO = "Cnpj inválido";
	public static final String TERMO_SERVICO_NAO_ASSINADO = "Termo de serviço não assinado";
	...
	public static final String ANALISE_LANCAMENTO_DATA_FIM = "Informe uma data fim para a análise de lançamentos";
